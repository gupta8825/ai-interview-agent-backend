...
export const generateQuestion = async (req, res) => {
  try {
    ...
    if (!userPrompt.trim()) {
      return res.status(400).json({
        message: "Promt content is empty.",
      });
    }
    ...
    const messages = [
      {
        ...
        -Keep language simple and coversational.
        ...
        Make questions based on the condidate's role, experience, interviewMode, projects,
...
export const submitAnswer = async (req, res) => {
  try {
    ...
    if (timeTaken > question.timeLimit) {
      question.score = 0;
      question.feedback = "Time limit exceeded. Answe not evaluated.";
    ...
    const messages = [
      {
        ...
        -If the answerr is strong and detailed, score high.
...
export const getInterviewReport = async (req, res) => {
  try {
    ...
    return res.status(500).json({message:`failed to find currnetUser interview ${error}`})
  }
};
